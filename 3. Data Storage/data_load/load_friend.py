...
def reviewdata_insert(db):
    with open('yelp_academic_dataset_friend.json', encoding='utf-8') as f:
        i = 0
        while True:
            i += 1
            lines = f.readline()
            ...
            try:
                ...
                result = [(data['user_id'], data['friend_id'])]
                insert_sql = "INSERT INTO friends (user_id, friend_id) VALUES (%s, %s)"
                cursor = db.cursor()
                try:
